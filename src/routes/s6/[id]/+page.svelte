...
<svelte:head>
	<title>{mergedData.infoKelas.kelas} - Ahmad Ramadhan</title>
	<meta name="description" content="Data Absensi" />
</svelte:head>
    ...
    <section class="pt-12 bg-gray-50 sm:pt-16">
        <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto text-center">
                ...
                <a href="{mergedData.AllLinks}" target="_blank" class="text-white bg-[#050708] hover:bg-[#050708]/90 focus:ring-4 focus:outline-none focus:ring-[#050708]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#050708]/50 dark:hover:bg-[#050708]/30 mr-2 mb-2 mt-2">
